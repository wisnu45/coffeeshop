...
<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
 ...
 <!--End Featured products Div-->
    ...
    <div class="container">
        <h2 class="title-div wow slideInLeft" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">Artikel</h2>
        <div class="products">
            <div class="row">
            <div class="panel-body">
                <div class="post-detail">
                <h3>{{ $itemartikel->header }}</h3><br>
                    
                {{ $itemartikel->deskripsi }}
                

                </div><br>
                <div class="info-meta">
                        <ul class="list-inline">
                            <li>Posting  {{ $itemartikel->created_at }}</li>
                        </ul>
                    </div>
            </div>
                <div class="clearfix"></div>
            ...
            <p style="text-align:right;">
                            <a href="{{ url('/artikels') }}" class="btn btn-primary">Artikel</a>
                        </p>
            <div class="clear"></div>
