...
<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
 ...
 <!--End Featured products Div-->
    ...
    <div class="container">
        <h2 class="title-div wow slideInLeft" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">Sign in</h2>
        <div class="products">
            <div class="row">
                 <div class="col-md-6">
                    <p>
                ...
                <div class="col-md-6">
                    ...
                    @endif
                <form action="{{ url('publish/signin/store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <button class="btn btn-primary btn-submit">SUBMIT</button>&nbsp;<a href="{{ url('/signup') }}" class="">Register</a>
                    </div>
