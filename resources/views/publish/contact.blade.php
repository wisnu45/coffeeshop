...
<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
 ...
 <!--End Featured products Div-->
    ...
    <div class="container">
        <h2 class="title-div wow slideInLeft" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">Contact us</h2>
        <div class="products">
            <div class="row">
                 <div class="col-md-6">
                    <p>
                    ...
                    <ul>
                        ...
                        <li>Mobile phone +62 823 7892 8845 </li>
                ...
                <div class="col-md-6">
                    ...
                    @endif
                <form method="POST" action="{{ url('publish/mesages/store') }}" enctype="multipart/form-data">
                @csrf
                    <div class="mb-3">
