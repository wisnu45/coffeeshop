...
<div class="content-area">
    <div class="main-slider">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a href="{{ url('/products') }}" class="btn btn-red slider-link wow slideInRight" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">Buy this Now</a>
        ...
        <div class="item">
          ...
          <div class="carousel-caption">
           <div class="slide-header-text wow rollIn" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">A place of all coffee products</div> <br />
           <a href="{{ url('/products') }}" class="btn btn-red slider-link wow zoomIn" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">View Our All Products</a>
       </div>
   </div>
...
<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
 ...
 <!--End Featured products Div-->
    ...
    <div class="container">
        <h2 class="title-div wow slideInLeft" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">Sign up</h2>
        <div class="products">
            <div class="row">
                 <div class="col-md-6">
                    <p>
                    ...
                    <ul>
                        ...
                        <li>Mobile phone +62 812 2222 3333 </li>
                        <li>Phone 0274 888888 </li>
                        <li>e-mail mycoffeshop@gmail.com</li>
                    </ul>    
                    </p>
                </div>
                <div class="col-md-6">
                    ...
                    @endif
                <form method="POST" action="{{ url('publish/signup/store') }}" enctype="multipart/form-data">
                @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="telp" name="telp" placeholder="Telepon *) 081888888888" required>
                    </div>
                    <div class="mb-3">
