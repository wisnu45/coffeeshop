...
<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
 ...
 <div class="latest-products">
    <div class="container">
        <h2 class="title-div wow slideInLeft" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">my Wishlist</h2>
        <div class="products">
        <form action="{{ url('publish/product/checkout') }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="row">
                <div class="modal-body">
                    ...
                    <table width="300" class="table">
                        ...
                        @endforelse
                            ...
                            <tr>
                                ...
                                <td>
                                <span class="bold text-primary" style="margin-left: 73%"></span>
                                </td>
                            </tr>
                            <div class="clearfix"></div>
                        </tbody>
                    </table><!-- End Latest products[single] -->  
            ...
            <a href="{{ url('/products') }}" class="btn btn-red btn-lg pull-left btn-more wow slideInLeft">Products</a>
            &nbsp;<button class="btn btn-blue btn-lg pull-right btn-more wow slideInRight" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10"> 
                <span>Check out </span>
            </button>
