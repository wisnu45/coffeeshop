...
<a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
 ...
 <!--End Featured products Div-->
    ...
    <div class="container">
        <h2 class="title-div wow slideInLeft" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10">Profil</h2>
        <div class="products">
            <div class="row">
            @forelse ($profils as $item)
                <div class="col-md-12">
                    <p>
                        <center><img src="{{ asset('storage/profil/'.$item->path.'')}}" class="img img-responsive" width="400" height="200"/></center><br>
                        <br>
                        {{ $item->deskripsi }}
                    </p>    
...
@include('publish.footer') <!-- End Footer top -->
 <!--End Footer bottom -->
